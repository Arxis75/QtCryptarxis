...
class RawStrByteSet : public ByteSet
{
    public:
        ...
        inline RawStrByteSet pop_front(uint64_t nb_element) { RawStrByteSet(ByteSet::pop_front(nb_element)); }

        inline void push_back(const string &val) { ByteSet::push_back(RawStrByteSet(val)); }
        inline RawStrByteSet pop_back(uint64_t nb_element) { RawStrByteSet(ByteSet::pop_back(nb_element)); }
};
